...
const Tabline = () => {
  return (
    <div className="bg-[#0dbbb9] text-white py-2 px-4 md:py-3 md:px-6 flex flex-col md:flex-row items-center justify-around">
      ...
      >
        <button className="bg-[#0d4c8f] text-white font-medium py-1 px-2 md:py-2 md:px-4 rounded flex items-center text-xs md:text-base whitespace-nowrap">
