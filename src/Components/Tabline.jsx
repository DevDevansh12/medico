...
const Tabline = () => {
  return (
    <div className="bg-[#0CB8B6] text-white py-2 px-4 md:py-3 md:px-6 flex flex-col md:flex-row items-center justify-center">
      {" "}
      ...
      <div className="flex flex-col md:flex-row items-center mb-2 md:mb-0">
        ...
        <div className="flex items-center mb-1 md:mb-0">
          <FaLocationDot className="h-4 w-4 md:h-6 md:w-6 mr-1 md:mr-2" />
          <span className="text-xs md:text-sm whitespace-nowrap">
